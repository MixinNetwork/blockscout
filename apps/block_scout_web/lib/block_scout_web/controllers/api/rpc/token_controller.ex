defmodule BlockScoutWeb.API.RPC.TokenController do
  ...
  @filter_assets [
    ...
    # IQ
    "336d5d97-329c-330d-8e62-2b7c9ba40ea0",
    # XIN
    ...
    # AKITA
    "aa189c4c-99ca-39eb-8d96-71a8f6f7218a",
    # RUM
    "4f2ec12c-22f4-3a9e-b757-c84b6415ea8f",
    # FIL
    "08285081-e1d8-4be6-9edc-e203afa932da",
    # AKT
    "9c612618-ca59-4583-af34-be9482f5002d",
    # MANA
    "c3dc19ae-d087-3279-ac51-dc655940256a",
    # EURT
    "2f5bef0e-d41a-3cf3-b6fa-b8dd0d8a3327",
    # PINK
    "14693c1a-d835-3572-b9b4-e0cbb62099e5",
    # DOT
    "54c61a72-b982-4034-a556-0d99e3c21e39",
    # TRX
    "25dabac5-056a-48ff-b9f9-f67395dc407c",
    # ALGO
    "706b6f84-3333-4e55-8e89-275e71ce9803",
    # XLM
    "56e63c06-b506-4ec5-885a-4a5ac17b83c1",
    # BTC
    "c6d0c728-2624-429b-8e0d-d9d19b6592fa",
    # LINK
    "f6f1c01c-8489-3346-b127-dc0dc09b9ce7",
    # XRP
  ...
  def getmixinassets(conn, _params) do
    ...
    erc20_assets =
      Enum.filter(total_assets, fn x ->
        x.type == "ERC-20" and not is_nil(x.mixin_asset_id) and Enum.member?(@filter_assets, x.mixin_asset_id)
      end)
